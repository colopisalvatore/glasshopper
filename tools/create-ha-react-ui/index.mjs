#!/usr/bin/env node
// create-wick — scaffold a fresh Home Assistant React dashboard with Wick.
//
//   npx create-wick my-dashboard
//   npx create-wick my-dashboard --template minimal
//
...
function help() {
  stdout.write(`create-wick — scaffold a Home Assistant React dashboard

Usage:
  npx create-wick <name> [--template <id>]
