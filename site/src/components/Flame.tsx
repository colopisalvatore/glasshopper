export function Flame({ size = 28 }: { size?: number }) {
  return (
    ...
    >
      <defs>
        <linearGradient id="wickFlame" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0" stopColor="#fcd34d" />
          <stop offset="0.45" stopColor="#fb923c" />
          <stop offset="1" stopColor="#ef4444" />
        </linearGradient>
        <linearGradient id="wickGlow" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0" stopColor="#fef3c7" stopOpacity="0.9" />
          <stop offset="1" stopColor="#fbbf24" stopOpacity="0" />
        </linearGradient>
        <linearGradient id="wickStick" x1="0" y1="0" x2="0" y2="1">
      ...
      {/* Outer glow */}
      <ellipse cx="14" cy="11" rx="9" ry="11" fill="url(#wickGlow)" />
      ...
      {/* Wick / candle stem */}
      <rect x="13" y="19" width="2" height="6" rx="1" fill="url(#wickStick)" />
    </svg>
  );
}
